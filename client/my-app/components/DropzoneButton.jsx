...
export function DropzoneButton({ files, setFiles, maxFiles, onUpload }) {
    ...
    return (
        <>
                ...
                >
                    <div style={{ pointerEvents: "none" }}>
                        ...
                        <Text align="center" weight={700} size="lg" mt="xl">
                            ...
                            <Dropzone.Reject>At max 5 images can be uploaded</Dropzone.Reject>
                            <Dropzone.Idle>Upload images</Dropzone.Idle>
                        </Text>
                        <Text align="center" size="sm" mt="xs" color="dimmed">
                            Drag&apos;n&apos;drop files here to upload. At max 5 images can be
                            uploaded
                        </Text>
                    </div>
                </Dropzone>
            ...
            {data && data.length > 0 && <CardsCarousel data={data} src={false} />}
        </>
    )
}
